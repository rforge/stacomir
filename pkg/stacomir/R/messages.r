...
# interface graphique
	...
	msg$interface_graphique$menu.1<-"Station"
	msg$interface_graphique$menu.1.1<-"DF"
	msg$interface_graphique$menu.1.2<-"DC"
	msg$interface_graphique$menu.1.3<-"Operation (TODO)"
	msg$interface_graphique$menu.1.4<-"DF sans DC (TODO)"
	msg$interface_graphique$menu.2<-"Bilan"
	msg$interface_graphique$menu.2.1<-"Migration"
	msg$interface_graphique$menu.2.2<-"Cond. Env."
	msg$interface_graphique$menu.2.3<-"Migr.~Cond. Env."
	msg$interface_graphique$menu.2.4<-"Migr./ parm. quant / parm. qual"
	msg$interface_graphique$menu.2.5<-"Migr. interannuel"
	msg$interface_graphique$menu.2.6<-"Parm. de lot"
	msg$interface_graphique$menu.2.7<-"Poids Moyen civelle"
	msg$interface_graphique$menu.2.8<-"Tailles"
	msg$interface_graphique$menu.2.9<-"Stades pigmentaires"
	msg$interface_graphique$menu.2.10<-"Migr. juvéniles (TODO)"
	msg$interface_graphique$menu.2.11<-"Migr. inter DC (TODO)"
	msg$interface_graphique$menu.2.12<-"parm qual (proportions) (TODO)"
	msg$interface_graphique$menu.2.13<-"Especes"
	msg$interface_graphique$menu.3<-"Aide"
# 	
	msg$interface_graphique$log.1<-"Connexion"
	msg$interface_graphique$log.2<-"Utilisateur"
	msg$interface_graphique$log.3<-"Mot de passe"
	msg$interface_graphique$log.4<-"Login"
	msg$interface_graphique$log.5<-"Erreur" # title of the frame
	msg$interface_graphique$log.6<-"Probleme lors du test de la connexion ODBC" 
	msg$interface_graphique$log.7<-"Erreur dans l'utilisation de la methode connect de la classe ConnexionODBC" 
	msg$interface_graphique$log.8<-"Probleme lors du test, le lien ODBC fonctionne mais ne pointe pas vers la base version 0.3, verifiez le lien ODBC"
	msg$interface_graphique$log.9<-"Lien ODBC"
